...
/**
 * Our simple agent for the ColorWorld GeoMASON example. The agents move in one
 * of the eight cardinal directions until they hit the boundary of Fairfax
 * County. Then, they choose a random direction, and repeat.
 *
 */
