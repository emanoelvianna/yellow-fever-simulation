...
public class ColorWorld extends SimState {
  ...
  // where all the agents live. We use a GeomVectorField since we want to
  // determine how
  // many agents are inside each district. The most efficient way to do this is
  // via
  ...
  public ColorWorld(long seed) throws MalformedURLException {
    super(seed);
    ...
    URL politicalBoundaries = new URL("file:data/pol.shp");
