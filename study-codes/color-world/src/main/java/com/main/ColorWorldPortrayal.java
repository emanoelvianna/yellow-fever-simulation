...
/**
 * We override GeomPortrayal so we can change the paint color for each voting
 * district based on how many agents are currently inside the district. After
 * setting the paint color, GeomPortrayal handles drawing in the standard
 * GeoMASON way.
 *
 */
