...
public class Rainfall implements Steppable {
  ...
  // final double area = 90.0 * 90.0;// meter square - cell resolution of the
  // model
  ...
  public void recieveRain(Dadaab d) {
    ...
    //
    // double rain_liter = d.params.global.getRainfall_MM_Per_Minute() * 0.001 *
    // coversionFactor; // 1m3 = 1000 litre, change rainf from mm to meter and
    // multiply 1000
